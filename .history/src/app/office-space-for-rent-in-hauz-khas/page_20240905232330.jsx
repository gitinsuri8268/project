...
const officespaceforrentinhauzkhas = () => {
 ...
 text-[12px]"
          ...
          <div className="py-[5px]">
            <h3 className="text-[16px] md:text-[18px] font-bold">FAQ&lsquo;s</h3>
          ...
          <div className="py-[5px]">
            ...
            <p className="py-[5px] font-light text-[12px] leading-relaxed">
              ...
              possible with Gitin Suri&lsquo;s competitive and flexible pricing. An
...
export default OfficeSpaceForRentInhauzkhas;
